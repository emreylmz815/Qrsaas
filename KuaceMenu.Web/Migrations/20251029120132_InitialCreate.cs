        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseDomain = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    WildcardEnabled = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DomainConfigs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPublicMenuEnabled = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
